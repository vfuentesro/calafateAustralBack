...
api_patterns = [
    ...
    path('compra/metodo-pago-api/', views.set_payment_method, name='api_set_payment_method_api'),
    path('compra/getnet-checkout/', views.getnet_checkout, name='api_getnet_checkout'),
]
